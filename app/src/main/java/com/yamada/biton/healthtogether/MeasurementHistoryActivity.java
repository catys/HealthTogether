...
public class MeasurementHistoryActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
// (2) グラフのタイトル、X軸Y軸ラベル、色等の設定
            ...
            renderer.setPointSize(15f);                      // ポイントマーカーサイズ
