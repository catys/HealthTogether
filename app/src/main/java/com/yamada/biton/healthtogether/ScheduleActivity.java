...
/*
        ...
        int dflag = 0;
        int carryflag = 0;
        int bday = Global.getDay();
        for(int i = 0; i < 7;i++){
            bday = bday + i;
            if(lastDayOfMonth == bday){
                dflag = i;
            }else if((10 == bday) && (i != 0)){
                carryflag = i;
            }
        ...
        int zflag = 0;
        int crflag = 0;
        int bmonth = Global.getMonth();
        if(bmonth < 10){
            zflag = 1;
            if((bmonth == 9) && (dflag != 0)){
                crflag = 1;
            }
        }else if((dflag != 0) && (bmonth == 12)){
            mflag = 1;
        }*/
        ...
        Global.setScheduleinfo(String.valueOf(Global.getYear()) + "-0" + String.valueOf(Global.getMonth()) + "-" + String.valueOf(Global.getDay() + 6),String.valueOf( cb7.isChecked()),String.valueOf( cb77.isChecked()),String.valueOf( cb777.isChecked()));
